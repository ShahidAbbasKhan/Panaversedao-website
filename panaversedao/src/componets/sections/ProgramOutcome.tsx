...
import outcome from "@/assests/images/outcome.png";
...
const ProgramOutcome = () => {
  return (
    <section>
      <Wrapper>
        <div className="flex flex-col-reverse md:flex-row gap-x-8 mt-14 md:mt-20 items-center">
          {/* Left Image  */}
          ...
          <div className="flex-1">
            ...
            <p className="mt-3 text-xl text-slate-600 text-justify">
            ...
            <div className="mt-6 text-xl font-bold text-slate-800 grid grid-cols-2 gap-x-2 gap-y-4">
